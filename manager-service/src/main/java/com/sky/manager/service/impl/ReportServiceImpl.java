...
//    private UserMapper userMapper;
    ...
    public UserReportVO getUserStatistics(LocalDate begin, LocalDate end) {
        ...
        for (LocalDate date : dateList) {
            ...
            Map map = new HashMap();
            map.put("end", endTime);
            Integer totalUser = userClient.countByMap(map); //截止到一天结束的用户总数
            map.put("begin", beginTime);
            Integer newUser = userClient.countByMap(map); //在这一天之内新增的用户数量
    ...
    public SalesTop10ReportVO getTop10SalesStatistics(LocalDate begin, LocalDate end) {
        ...
        List<GoodsSalesDTO> salesTop10 = orderClient.getSalesTop10(beginTime, endTime);
